...
////    dd(new App\Mail\ActivationUserAccount( \App\User::find(1) , '111111234') );
//    Mail::to(\App\User::find(1))->send(new App\Mail\ActivationUserAccount( \App\User::find(1) , '111111234'));
//   return 'done';
//});
