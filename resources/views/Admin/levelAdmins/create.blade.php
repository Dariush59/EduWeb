...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="page-header head-section">
            <h2>{{__('messages.ROLE_REGISTRATION')}}</h2>
        </div>
        <form class="form-horizontal" action="{{ route('level.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="user_id" class="control-label">{{__('messages.USERS')}}کاربران</label>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label for="role_id" class="control-label">{{__('messages.ROLES')}}</label>
