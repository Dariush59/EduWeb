...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3>{{__('messages.HOME.LAST_COURSES')}}</h3>
        </div>
    </div>
    <div class="row ">
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            <a href="{{ $course->path()  }}" class="btn btn-primary">{{__('messages.BUY')}}</a> <a href="{{ $course->path()  }}" class="btn btn-default">اطلاعات بیشتر</a>
                        </p>
                    </div>
                    <div class="ratings">
            ...
            @foreach($articles as $article)
                <div class="col-sm-4 col-lg-4 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="ratings">
                            <p class="pull-right">{{ $article->viewCount }} {{__('messages.HOME.VIEWED')}}</p>
