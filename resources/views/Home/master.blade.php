...
<head>
    ...
    @elseif(app()->getLocale() == 'en')
        <link href="/css/home.css" rel="stylesheet">
    @endif
    <link rel="alternate" type="application/rss+xml" title="فید مقالات" href="/feed/articles">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-left">
                @if(auth()->check())
                    <li>
                        <a href="{{ route('user.panel') }}">{{__('messages.USER_PANEL.TITLE')}}</a>
                    </li>
                    <li>
