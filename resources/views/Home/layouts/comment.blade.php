...
@else
    <div class="alert alert-danger">{{__('messages.LOGGED_TO_COMMIT')}}</div>
@endif
    ...
    <div class="media">
        ...
        <div class="media-body">
            <h4 class="media-heading">{{ $comment->user->name }}
                ...
                <button class="pull-left btn btn-xs btn-success" data-toggle="modal" data-target="#sendCommentModal" data-parent="{{ $comment->id }}">{{__('messages.ANSWER')}}</button>
            </h4>
            {!! $comment->comment !!}
            <!-- Nested Comment -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="exampleModalLabel">{{__('messages.SEND_ANSWER')}}</h4>
            </div>
            <div class="modal-body">
                <form action="/comment" method="post">
                    ...
                    <div class="form-group">
                        <label for="message-text" class="control-label">{{__('messages.ANSWER_TEXT')}}</label>
